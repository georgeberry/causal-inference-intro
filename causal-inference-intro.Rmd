...
author: "George Berry, Cornell University"
date: "3/9/2019, version 1.0"
output:
  pdf_document:
    fig_caption: yes
    includes:
...
Let's take another look at the causal graph we previewed earlier, where $X$ causes the treatment $D$ and outocme $Y$, and the treatment $D$ causes $Y$.
